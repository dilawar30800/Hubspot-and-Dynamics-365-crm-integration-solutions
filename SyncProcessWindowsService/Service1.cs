...
namespace SyncProcessWindowsService
{
    ...
    public partial class Service1 : ServiceBase
    {
        ...
        //variables for async task
        private static bool _stateRunning = false;
        private static CancellationTokenSource _tokenSource;
        private Task t;
        private CancellationToken token;

        //ending variable for async task


        //code for activities sync
        ...
        public  void ErrorLogging(Exception ex, string param)
        {
        ...
        public  void CustomLogging(string param)
        {
        ...
        public  void Sync()
        {
           ...
           // Program prg = new Program();
            ...
            try
            {
                ...
                List<PhoneCall> list = GetAllEngagements(time);
                ...
                if (list.Count > 0)
                {
                    ...
                    CustomLogging("===========End============= ");
                    WriteToFile("Data written in Dynamics: " + responseWithResults.Responses.Count);
                }
                else
                {
        ...
        //{
        //    WriteToFile("Sync Process is started at " + DateTime.Now);
        //    Sync();
        //    WriteToFile("Sync Process is Ended  at " + DateTime.Now);
        ...
        protected override void OnStart(string[] args)
        {
            ...
            ThreadStart start = new ThreadStart(Sync); // FaxWorker is where the work gets done
